...
class RegularReplacementPos(models.Model):
    ...
    payment = models.IntegerField(verbose_name='Ступень оплаты по штатному расписанию', max_length=3)
    ...
    payment_rr = models.IntegerField(verbose_name='Ступень оплаты по штатному замещению', blank=True,max_length=3)
